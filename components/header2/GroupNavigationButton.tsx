...
const GroupsNavigationButton = ({
  ...
  return (
    <li
      className="hidden [1100px]:flex w-28 h-full flex-col items-center justify-endrelative z-[1] relative"
      id="nav-link"
    >
      <div
        id="nav-title"
...
export default GroupsNavigationButton;
